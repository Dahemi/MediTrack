      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">Check Queue Status</h4>
                    <p className="text-gray-600 text-sm">See if the doctor's queue is active or paused before booking</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">Get Real-time Updates</h4>
                    <p className="text-gray-600 text-sm">Receive instant notifications when queue status changes</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">Plan Your Visit</h4>
                    <p className="text-gray-600 text-sm">Make informed decisions about when to book appointments</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">For Clinics</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">Control Your Queue</h4>
                    <p className="text-gray-600 text-sm">Pause/resume your queue for breaks, emergencies, or lunch</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Reschedule or cancel appointments when needed</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Patients are automatically notified of all changes</p>
                  </div>
                </div>
              </div>
            </div>
