        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Select the perfect MediTrack plan for your healthcare practice. All plans include our core features with no hidden fees.
            </p>
          </div>
        </div>
      </section>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Why Choose MediTrack?</h2>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Everything you need to know about MediTrack pricing</p>
          </div>
