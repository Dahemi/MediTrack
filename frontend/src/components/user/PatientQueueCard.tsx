          ...
          <div className="space-y-3">
            {nextAppointments.length === 0 ? (
              ...
              nextAppointments.map((ap, index) => {
                ...
                return (
                  <div key={ap._id} className={`flex items-center justify-between p-4 rounded-xl transition-all duration-200 ${
                    isCurrentUser 
                    ...
                    <div className="flex items-center space-x-4">
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center shadow-sm ${
                        isCurrentUser ? 'bg-gradient-to-br from-blue-500 to-blue-600' : 'bg-gradient-to-br from-blue-100 to-blue-200'
                      }`}>
                        <span className={`font-bold text-sm ${
                          isCurrentUser ? 'text-white' : 'text-blue-700'
                        }`}>
                      ...
                      <div>
                        ...
                        <div className={`text-sm mt-0.5 ${
                          isCurrentUser ? 'text-blue-700 font-medium' : 'text-gray-600'
                        }`}>
                          Appointment • {ap.time}
                        </div>
                      </div>
